...
public class Village {
	...
	private Marche marche;
 	...
 	private static class Marche {
		...
		String afficherMarche() {
			...
			if(nbEtalLibre >= 0) {
				stringBuilder.append("Il reste " + nbEtalLibre + " étals non utilisés dans le marché");
	...
	public String afficherMarche() {
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append("Le marché du vilalge \"le village de irréductibles\" possède plusieurs étals : \n");
		return stringBuilder.append(marche.afficherMarche()).toString();
	}
